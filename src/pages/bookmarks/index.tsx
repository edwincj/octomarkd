...
export default function Bookmarks() {
  ...
  const validateRepository = async (repoFullName: string): Promise<any> => {
    try {
  ...
  const handleImportCsv = async () => {
    ...
    try {
      ...
      //   );
      //   const existingIds = new Set(existingBookmarks.map((b: any) => b.id));
      ...
      //   const updatedBookmarks = [...existingBookmarks, ...validRepositories];
